...
function ParentComp() {
  const ProductData = [
    ...
    },
    {
      ...
      price: 19.99,
      image: "https://images.unsplash.com/photo-1626954610461-c1a8c4734c20?w=500&h=500&fit=crop"
    },
    {
      id: 13,
      ...
      <div className="min-h-screen bg-black text-white p-8">
        <div className="max-w-7xl mx-auto">
          <div className="mb-12 text-center">
            ...
            <p className="text-gray-400 text-lg">Discover amazing products at great prices</p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {/* <ProductList prodImg={ProductData[0].image} prodTitle={ProductData[0].title} prodDes={ProductData[0].description} prodPrice={ProductData[0].price}/> */}

            {
              ProductData.map(product => 
              //  <ProductList key={product.id} prodImg={product.image} prodTitle={product.title} prodDes={product.description} prodPrice={product.price} />
                <ItemComp key={product.id} prodImg={product.image} prodTitle={product.title} prodDes={product.description} prodPrice={product.price} />
              )
            }
